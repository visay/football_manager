	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_footballmanager_domain_model_player.pid=###CURRENT_PID### AND tx_footballmanager_domain_model_player.sys_language_uid IN (-1,0)',
			),
		),
		...
		'photo' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:football_manager/Resources/Private/Language/locallang_db.xlf:tx_footballmanager_domain_model_player.photo',
			'config' => array(
				'type' => 'group',
				'internal_type' => 'file',
